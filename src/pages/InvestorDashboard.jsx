    ...
    try {
      if (userData && userData._id) {
        ...
        if (pendingAgreements.length > 0) {
          ...
          let message = '📋 Agreement received! Please review the investment terms and conditions.';
          if (startupSigned && !investorSigned) {
            message = `✅ Startup has signed the agreement! Please review and accept the investment conditions to complete the process.`;
          } else if (investorSigned && !startupSigned) {
            message = '📋 Investment conditions accepted! A notification has been sent to the startup to finalize the agreement.';
          }
